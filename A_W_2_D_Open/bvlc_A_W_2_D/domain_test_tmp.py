...
saved_state_dict = torch.load(osp.join(MAIN_DIR,"MSDA/A_W_2_D_Open/bvlc_A_W_2_D/pretrain/office/bvlc_extractor.pth"))
...
saved_state_dict1 = torch.load(osp.join(MAIN_DIR,"MSDA/A_W_2_D_Open/bvlc_A_W_2_D/pretrain/office/bvlc_s1_cls.pth"))
